...
WORD_LENGTH_32           = 0x00_00_00_01
BIG_ENDIAN               = 0x00_00_00_02
HIGH_SPEED               = 0x00_00_00_10
INT_POLARITY_HIGH        = 0x00_00_00_20
WAKE_UP                  = 0x00_00_00_80
STATUS_ENABLE            = 0x00_01_00_00
INTR_WITH_STATUS         = 0x00_02_00_00

# Interrupt register values - these aren't fully described in the specification

DATA_UNAVAILABLE         = 0x00_01
COMMAND_ERROR            = 0x00_08
DATA_ERROR               = 0x00_10
F1_OVERFLOW              = 0x00_80

# Interrupt enable values

F2_F3_FIFO_RD_UNDERFLOW  = 0x00_02
F2_F3_FIFO_WR_OVERFLOW   = 0x00_04
COMMAND_ERROR            = 0x00_08
DATA_ERROR               = 0x00_10
F2_PACKET_AVAILABLE      = 0x00_20
F1_OVERFLOW              = 0x00_80
F1_INTR                  = 0x20_00
...
STATUS_F2_RX_READY       = 0x00_00_00_20

# BACKPLANE REGISTERS
#
# Backplane registers

SDIO_FUNCTION2_WATERMARK = 0x1_00_08 
BACKPLANE_LOW_REG        = 0x1_00_0a
BACKPLANE_MED_REG        = 0x1_00_0b
BACKPLANE_HIGH_REG       = 0x1_00_0c
SDIO_CHIP_CLOCK_CSR      = 0x1_00_0e
SDIO_PULL_UP             = 0x1_00_0f
...
# Backplane registers
WLAN_BASE_ADDRESS_REG    = 0x18_00_0d_68
HOST_CONTROL_REG         = 0x18_00_0d_6c
BT_CONTROL_REG           = 0x18_00_0c_7c

# Host control register values
WAKE_BT                  = 0x00_02_00_00
DATA_VALID               = 0x00_00_00_02
SW_READY                 = 0x01_00_00_00

# BT control register values
BT_AWAKE                 = 0x00_00_01_00
FW_READY                 = 0x01_00_00_00
...
CHIPCOMMON_BASE_ADDRESS  = 0x18_00_00_00
SDIO_BASE_ADDRESS        = 0x18_00_20_00
WLAN_ARMCM3_BASE_ADDRESS = 0x18_00_30_00
SOCSRAM_BASE_ADDRESS     = 0x18_00_40_00

WRAPPER_REGISTER_OFFSET  = 0x10_00_00

SBSDIO_SB_ACCESS_2_4B    = 0x80_00             # Not sure what this does or if it works

# Core control

AI_IOCTRL_OFFSET         = 0x04_08
AI_RESETCTRL_OFFSET      = 0x08_00

SICF_CPUHALT             = 0x00_20
SICF_FGC                 = 0x00_02
SICF_CLOCK_EN            = 0x00_01
...
def setup():
    print("**** SET UP CHIP")
    print(">>>> Check SPI working")
    print(">>>> Send empty bytes to clear 4-bit buffer")
    read = spi_transfer(b'x00', 1, 0)  # Just to clear the 4bit extra needed
    print_hex(">>>> SPI transfer read", read)
    
    print(">>>> Try to read FEEDBEAD")
...
print("NOW START A TRANSACTION")
print("Get buffer pointers")

send_head = cyw_read_backplane_reg_u32(wifi_base + 0x2000)
print_hex_val_u32("Send head", send_head)
send_tail = cyw_read_backplane_reg_u32(wifi_base+ 0x2004)
print_hex_val_u32("Send tail", send_tail)
receive_head = cyw_read_backplane_reg_u32(wifi_base + 0x2008)
print_hex_val_u32("Receive head", receive_head)
receive_tail = cyw_read_backplane_reg_u32(wifi_base + 0x200c)
print_hex_val_u32("Receive tail", receive_tail)

print("Write data")
dat = b'\x03\x00\x00\x01\x03\x0c\x00\x00'
cyw_write_backplane_bytes(wifi_base + 0x0000, dat, len(dat))
cyw_write_backplane_reg_u32(wifi_base + 0x2000, 8)
read = cyw_read_backplane_reg_u32(wifi_base + 0x2000)
print_hex_val_u32("Send head", read)
...
print("Bytes to read: ", receive_head - receive_tail)

print("Read data")
buf = cyw_read_backplane_bytes(wifi_base + 0x1000 + receive_tail, receive_head - receive_tail)
print_hex("BT data", buf)
